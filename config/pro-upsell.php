...
return [
    ...
    'features'   => [
        ...
        [
            'en' => ['title' => 'Extends free Ankro', 'desc' => 'Requires the active free Anchor plugin; delivered through Freemius with licensing and automatic updates.'],
            'pl' => ['title' => 'Rozszerza darmowy Ankro', 'desc' => 'Wymaga aktywnej darmowej wtyczki Anchor; dostarczany przez Freemius z licencją i automatycznymi aktualizacjami.'],
        ],
    ],
];
