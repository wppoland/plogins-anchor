 ...
 * Ankro"). Stores settings in the `anchor_settings` option (array): the master
...
final class Settings implements HasHooks
{
    ...
    public function addMenuPage(): void
    {
        add_submenu_page(
            'woocommerce',
            __('Ankro: Sticky Add to Cart Bar', 'ankro'),
            __('Ankro', 'ankro'),
            'manage_woocommerce',
            self::PAGE,
            [$this, 'renderPage'],
        ...
        <div class="wrap anchor-admin">
            ...
            <form method="post" action="options.php">
                ...
                <div class="anchor-card">
                    <h2><?php esc_html_e('Display', 'ankro'); ?></h2>
                    <table class="form-table" role="presentation">
                        <tbody>
                            <tr>
                                <th scope="row"><?php esc_html_e('Enable the bar', 'ankro'); ?></th>
                                <td>
                                    <label for="anchor_enabled">
                                        ...
                                        />
                                        <?php esc_html_e('Show the sticky add-to-cart bar on single product pages.', 'ankro'); ?>
                                    </label>
                                    <p class="description">
                                        <?php esc_html_e('When off, the bar never renders and its CSS/JS are not loaded, zero front-end impact.', 'ankro'); ?>
                                    </p>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">
                                    <label for="anchor_scroll_threshold"><?php esc_html_e('Scroll threshold (px)', 'ankro'); ?></label>
                                </th>
                                <td>
                                    <input
                                        type="number"
                                    ...
                                    <p class="description">
                                        ...
                                        printf(
                                            ...
                                            esc_html__('How far past the main add-to-cart form the shopper must scroll before the bar appears (%1$d, %2$d). 300 is a good default.', 'ankro'),
                                    ...
                                    <span class="anchor-hint">
                                        ...
                                        printf(
                                            ...
                                            esc_html__('Lower means the bar shows up sooner; higher keeps it hidden longer. Right now it appears after %s of scrolling.', 'ankro'),
                ...
                <?php
                /**
                 * Fires inside the Ankro settings form, after the core cards and
    ...
    public function sanitize(mixed $raw): array
    {
        ...
        /**
         * Filters the sanitised Ankro settings before they are saved.
         *
