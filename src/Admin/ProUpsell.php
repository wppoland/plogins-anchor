...
/**
 * PRO upgrade promotion, shown ONLY on the Cartdock settings screen: a dismissible
...
final class ProUpsell
{
    ...
    public function enabled(): bool
    {
        ...
        /**
         * Filters whether the Cartdock PRO promo is shown on the settings screen.
         *
    ...
    private function url(): string
    {
         ...
         *
         * @param string $url Default the Cartdock PRO page.
         */
    ...
    private function priceLabel(): string
    {
        ...
        if (! empty($d['price_from'])) {
            ...
            return sprintf(__('from %1$s%2$d/yr', 'cartdock'), $cur, (int) $d['price_from']);
        }
        return '';
    }
    ...
    public function handleDismiss(): void
    {
        if (! current_user_can('manage_woocommerce')) {
            wp_die(esc_html__('Permission denied.', 'cartdock'));
        }
    ...
    public function banner(): void
    {
        ...
        $name     = (string) ($this->data()['name'] ?? 'Cartdock Pro');
        ...
        <div class="anchor-pro-banner" role="note">
            ...
            <p class="anchor-pro-banner__text">
                ...
                printf(esc_html__('Do more with %s', 'cartdock'), esc_html($name)); ?></strong>
            ...
            <a class="anchor-pro-banner__dismiss" href="<?php echo esc_url($this->dismissUrl()); ?>" aria-label="<?php esc_attr_e('Dismiss this notice', 'cartdock'); ?>">&times;</a>
        </div>
        <?php
    }
    ...
    public function aside(): void
    {
        ...
        <aside class="anchor-card anchor-pro-aside" aria-labelledby="anchor-pro-aside-h">
            ...
            <h2 id="anchor-pro-aside-h" class="anchor-pro-aside__heading"><?php esc_html_e('Unlock every PRO feature', 'cartdock'); ?></h2>
            ...
            <?php if ($price !== '') : ?>
                <p class="anchor-pro-aside__price"><?php echo esc_html($price); ?><?php if ($this->sellable()) : ?> · <?php esc_html_e('one licence, every PRO feature', 'cartdock'); ?><?php endif; ?></p>
            <?php endif; ?>
        </aside>
        <?php
    }
    ...
    public function cards(): void
    {
        ...
        <section class="anchor-pro-cards" aria-labelledby="anchor-pro-cards-h">
            <h2 id="anchor-pro-cards-h" class="anchor-pro-cards__title">
                <?php
                /* translators: %s: PRO edition name */
                printf(esc_html__('What %s adds', 'cartdock'), esc_html($name)); ?>
            </h2>
